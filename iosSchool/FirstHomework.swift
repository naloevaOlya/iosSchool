...
func printInfo(gamer: CreatureProtocol, monster: CreatureProtocol) {
    print("Gamer health: \(gamer.health), \nMonster health: \(monster.health)")
}

func printResult(gamer: CreatureProtocol) {
    if gamer.isAlive() {
        print("Gamer winner!")
    } else {
